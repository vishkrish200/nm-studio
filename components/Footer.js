...
const SpecialColumns = styled.div`
  display: grid;
...
const SpecialColumn2 = styled.div`
  /* display: grid;
  grid-template-rows: repeat(1, minmax(0, 0.75fr));
  grid-auto-flow: column; */
  @media (max-width: 768px) {
        ...
        <Rows>
          ...
          <Row>
            <SpecialColumns>
              <Column>
                <Image
                  src="/attachments/NEEL_Icons-01.png"
                  layout="intrinsic"
                  width={100}
                  height={100}
                  objectFit="contain"
              ...
              <Column>
                <Image
                  src="/attachments/NEEL_Icons-02.png"
                  layout="intrinsic"
                  width={100}
                  height={100}
                  objectFit="contain"
              ...
              <Column>
                <Image
                  src="/attachments/NEEL_Icons-03.png"
                  layout="intrinsic"
                  width={100}
                  height={100}
                  objectFit="contain"
              ...
              <Column>
                <Image
                  src="/attachments/NEEL_Icons-04.png"
                  layout="intrinsic"
                  width={100}
                  height={100}
                  objectFit="contain"
              ...
              <Column>
                <Image
                  src="/attachments/NEEL_Icons-05.png"
                  layout="intrinsic"
                  width={100}
                  height={100}
                  objectFit="contain"
